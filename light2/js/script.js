...
(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        cards.forEach(card => {
            ...
            const button = card.querySelector(".arrow-icon-btn");
            ...
            // Auto switch image every 2 seconds
            setInterval(() => {
                index = (index + 1) % images.length;
                img.src = images[index];
                img.setAttribute("data-index", index);
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var selects = document.querySelectorAll('.lets-talk select');
