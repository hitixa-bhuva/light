            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/10.jpeg" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/10.jpeg" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/15.jpeg" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/15.jpeg" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/20.jpg" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/20.jpg" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/25.JPG" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/25.JPG" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/30.JPG" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/30.JPG" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/35.JPG" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/35.JPG" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/40.JPG" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/40.JPG" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-3 gallery-item animate-box" data-animate-effect="fadeInUp">
                        <a href="images/c projects/27.JPG" title="Image Gallery" class="img-zoom">
                            <div class="gallery-box">
                                <div class="gallery-img"> <img src="images/c projects/27.JPG" class="img-fluid mx-auto d-block" alt=""> </div>
                                <div class="gallery-detail text-center"> <i class="ti-fullscreen"></i> </div>
                            </div>
                        </a>
                    </div>
