...
console.log("Collected form data:", { firstName, email, phone, reach, message, subject });
...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            <div class="fields-grid">
                ...
                <div class="field-card">
                    <div class="field-icon">👤</div>
                    <div class="field-label">How did you reach us</div>
                    <div class="field-value">${reach}</div>
                </div>
   ...
   if (!firstName || !email || !phone || !reach || !subject || !message) {
    ...
    if (!message) {
        ...
        if (!reach) {
            toggleClassForField('reach', 'border-danger', 3000);
        }
        if (!email) {
